...
public class UserData {
    ...
    private void doLoadBaseStatsFromALLLOCALDATA(int charID) {
    ...
    private void doLoadCurrentStatsFromALLLOCALDATA(int charSlot) {
    ...
    public void doLoadCharDataFromALLLOCALDATA() {
        reset();
        ...
        for (DBTable2LoginHasCharacters loadFromInfo2 : AllLocalData.getInstance().getInfo2LoginHasCharacters()) {
            ...
            doLoadCurrentStatsFromALLLOCALDATA(slot);

            if (loadFromInfo2.getCharacters_idNr() == 1) {
                //make if CharID is 1 make WARRIOR

                doLoadBaseStatsFromALLLOCALDATA(1);
                ...
                doLoadBaseStatsFromALLLOCALDATA(2);
                ...
                doLoadBaseStatsFromALLLOCALDATA(3);
    ...
    public void doSaveCharDataToALLLOCALDATA() {
